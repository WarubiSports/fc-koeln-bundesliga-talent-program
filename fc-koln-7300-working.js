...
<body>
    ...
    <script>
        ...
        window.displayPendingApplications = function() {
            ...
            pendingApplications.forEach(function(app) {
                ...
                if (app.type === 'player') {
                    ...
                    html += '<p><strong>Date of Birth:</strong> ' + (app.dateOfBirth || 'Not provided') + '</p>';
        ...
        window.approveApplication = function(applicationId) {
            const app = pendingApplications.find(function(a) { return a.id === applicationId; });
            if (!app) return;

            if (confirm('Approve application for ' + app.firstName + ' ' + app.lastName + '?')) {
                // Remove from pending applications
                const index = pendingApplications.findIndex(function(a) { return a.id === applicationId; });
                if (index > -1) {
                ...
                console.log('Application approved:', app);
                alert('✅ Application approved successfully!\\n\\nUser account created for ' + app.firstName + ' ' + app.lastName + '\\nDefault password: ITP2024\\n\\nNotification email will be sent to: ' + app.email);
            }
        };
