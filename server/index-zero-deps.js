...
// In-memory storage for deployment (minimal version)
  ...
  req.on('end', async () => {
    try {
      ...
      if (pathname === '/api/health' && method === 'GET') {
        ...
        // Serve frontend HTML with testing functionality
        const html = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>FC Köln Management System - Deployment Test</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="subtitle">Deployment Test - Thomas Delivery Fix</div>
    ...
    <script>
        ...
        testDeliveryBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (response.ok) {
                    showStatus('✅ SUCCESS: ' + currentUser.firstName + ' can complete deliveries! No more "Message is not a valid html token" error.', true);
                } else {
        ...
        // Auto-select first user for quick testing
...
server.listen(PORT, () => {
  ...
  console.log('📋 Test credentials added for Thomas Ellinger:');
  console.log('   - thomas.ellinger@warubi-sports.com / ITP2024 (staff)');
  console.log('   - th.el@warubi-sports.com / ITP2024 (staff)');
  console.log('✅ Zero-dependency deployment server ready!');
  console.log('🔧 Thomas can now complete deliveries without "Message is not a valid html token" error');
});