...
function yr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === '' ? '.' : r + ':'), Io(e)))
    ...
    for (e = s.call(e), i = 0; !(u = e.next()).done; )
      ((u = u.value), (s = r + gl(u, i++)), (o += yr(u, t, n, s, l)));
  else if (u === 'object')
    throw (
      (t = String(e)),
      Error(
...
var oe = { current: null },
  gr = { transition: null },
  gf = { ReactCurrentDispatcher: oe, ReactCurrentBatchConfig: gr, ReactCurrentOwner: $u };
function qi() {
...
L.cloneElement = function (e, t, n) {
  ...
  if (t != null) {
    if (
      (t.ref !== void 0 && ((u = t.ref), (o = $u.current)),
    ...
    (e.unstable_scheduleCallback = function (C, N, z) {
      ...
      return (
        ...
        z > H
          ? ((C.sortIndex = z),
            t(f, C),
            n(s) === null && C === n(f) && (S ? (c(P), (P = -1)) : (S = !0), hl(h, z - H)))
          : ((C.sortIndex = X), t(s, C), w || g || ((w = !0), vl(E))),
        C
      );
    }),
...
var He = !(
  ...
  Uo = {};
function Lf(e) {
  return Ql.call(Uo, e) ? !0 : Ql.call(jo, e) ? !1 : zf.test(e) ? (Uo[e] = !0) : ((jo[e] = !0), !1);
}
function Tf(e, t, n, r) {
...
function Jl(e, t) {
  ...
  (t.hasOwnProperty('value')
    ? ql(e, t.type, n)
    : t.hasOwnProperty('defaultValue') && ql(e, t.type, at(t.defaultValue)),
...
function hs() {
  if (Wt) {
    var e = Wt,
      t = Qt;
    if (((Qt = Wt = null), Wo(e), t)) for (e = 0; e < t.length; e++) Wo(t[e]);
  }
}
function ys(e, t) {
  return e(t);
...
function Jf(e, t) {
  for (
    ...
    var o = 31 - Te(u),
      i = 1 << o,
      s = l[o];
    (s === -1 ? (!(i & n) || i & r) && (l[o] = Zf(i, t)) : s <= t && (e.expiredLanes |= i),
      (u &= ~i));
  }
}
function iu(e) {
...
function cn(e, t) {
  e.blockedOn === t &&
    ((e.blockedOn = null),
    su || ((su = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, tc)));
}
function In(e) {
  function t(l) {
    return cn(l, e);
  ...
  for (; 0 < Je.length && ((n = Je[0]), n.blockedOn === null); )
    (Os(n), n.blockedOn === null && Je.shift());
}
...
function qu(e, t, n, r) {
  if (Dr) {
    var l = au(e, t, n, r);
    if (l === null) (Ml(e, t, r, Ir, n), Yo(e, r));
    else if (ec(l, e, t, n, r)) r.stopPropagation();
    else if ((Yo(e, r), t & 4 && -1 < bf.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zn(l);
        if ((u !== null && zs(u), (u = au(e, t, n, r)), u === null && Ml(e, t, r, Ir, n), u === l))
          break;
        l = u;
      }
...
var Ir = null;
function au(e, t, n, r) {
  if (((Ir = null), (e = Xu(r)), (e = gt(e)), e !== null))
...
var rn = {
  ...
  tl = A({}, Gn, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== dn &&
            (dn && e.type === 'mousemove'
              ? ((_l = e.screenX - dn.screenX), (xl = e.screenY - dn.screenY))
              : (xl = _l = 0),
            (dn = e)),
          _l);
    },
  ...
  Zo = ge(tl),
  uc = A({}, tl, { dataTransfer: 0 }),
  oc = ge(uc),
  ic = A({}, Gn, { relatedTarget: 0 }),
  Pl = ge(ic),
  sc = A({}, rn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ac = ge(sc),
  fc = A({}, rn, {
...
var yc = A({}, Gn, {
  ...
  kc = ge(Sc),
  Ec = A({}, rn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cc = ge(Ec),
  _c = A({}, tl, {
    deltaX: function (e) {
...
var Nc = He && 'TextEvent' in window && !Cn,
  Is = He && (!no || (Cn && 8 < Cn && 11 >= Cn)),
  bo = ' ',
  ei = !1;
function Fs(e, t) {
  switch (e) {
...
if (He) {
  ...
  if (He) {
    ...
    if (!zl) {
      ...
      (ni.setAttribute('oninput', 'return;'), (zl = typeof ni.oninput == 'function'));
    }
    Nl = zl;
  } else Nl = !1;
...
var $c = He && 'documentMode' in document && 11 >= document.documentMode,
  Dt = null,
  fu = null,
  xn = null,
  cu = !1;
...
for (var Tl = 0; Tl < ii.length; Tl++) {
  var Rl = ii[Tl],
    Ac = Rl.toLowerCase(),
    Vc = Rl[0].toUpperCase() + Rl.slice(1);
  ct(Ac, 'on' + Vc);
}
...
var wn =
  ...
  Bc = new Set('cancel close invalid load scroll toggle'.split(' ').concat(wn));
function si(e, t, n) {
...
function Zs(e, t, n, r) {
  ...
  ((n = l.bind(null, t, n, e)),
    (l = void 0),
    !uu || (t !== 'touchstart' && t !== 'touchmove' && t !== 'wheel') || (l = !0),
    r
      ? l !== void 0
      ...
      if (p !== void 0) {
        ...
        for (var a = f, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h), c !== null && ((h = On(a, c)), h != null && S.push($n(a, h, d)))),
            F)
          )
            break;
          a = a.return;
    ...
    if (!(t & 7)) {
      e: {
        if (
          ...
          p && n !== ru && (w = n.relatedTarget || n.fromElement) && (gt(w) || w[We]))
        )
          break e;
        if (
          (g || p) &&
          ...
          g
            ? ((w = n.relatedTarget || n.toElement),
              (g = f),
              (w = w ? gt(w) : null),
              w !== null && ((F = Lt(w)), w !== F || (w.tag !== 5 && w.tag !== 6)) && (w = null))
            : ((g = null), (w = f)),
          g !== w)
        ) {
          if (
            ...
            (e === 'pointerout' || e === 'pointerover') &&
              ((S = qo), (h = 'onPointerLeave'), (c = 'onPointerEnter'), (a = 'pointer')),
            (F = g == null ? p : Ft(g)),
            (d = w == null ? p : Ft(w)),
      ...
      switch (((_ = f ? Ft(f) : window), e)) {
        case 'focusin':
          (ti(_) || _.contentEditable === 'true') && ((Dt = _), (fu = f), (xn = null));
          break;
        case 'focusout':
          xn = fu = Dt = null;
          break;
      ...
      (P &&
        (Is &&
          ...
          (Mt || P !== 'onCompositionStart'
            ? P === 'onCompositionEnd' && Mt && (x = Ds())
            : ((be = v), (bu = 'value' in be ? be.value : be.textContent), (Mt = !0))),
        (_ = Fr(f, P)),
        0 < _.length &&
...
var ln = Math.random().toString(36).slice(2),
  ...
  hu = '__reactEvents$' + ln,
  Xc = '__reactListeners$' + ln,
  Gc = '__reactHandles$' + ln;
function gt(e) {
  var t = e[Ie];
  if (t) return t;
...
function pt() {
  if (!Il && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(Gu, pt), l);
    } finally {
      ((O = t), (Il = !1));
    }
  }
...
function bs(e, t, n) {
  ((we[Se++] = Ae), (we[Se++] = Ve), (we[Se++] = _t), (_t = e));
  var r = Ae;
  e = Ve;
  var l = 32 - Te(r) - 1;
  ((r &= ~(1 << l)), (n += 1));
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = _t !== null ? { id: Ae, overflow: Ve } : null),
  ...
  if (j) {
    ...
    if (t) {
      ...
      if (!vi(e, t)) {
        ...
        t = lt(n.nextSibling);
        var r = ve;
        t && vi(e, t) ? ea(r, n) : ((e.flags = (e.flags & -4097) | 2), (j = !1), (ve = e));
      }
    } else {
      if (gu(e)) throw Error(y(418));
  ...
  function S(c, a, d, h) {
    ...
    if (x === null) {
      for (; !T.done; P++, T = d.next())
        ((T = m(c, T.value, h)),
          T !== null && ((a = u(T, a, P)), _ === null ? (E = T) : (_.sibling = T), (_ = T)));
      return (j && ht(c, P), E);
    }
    ...
    return (typeof d == 'string' && d !== '') || typeof d == 'number'
      ? ((d = '' + d),
        a !== null && a.tag === 6
          ...
          : (n(c, a), (a = Bl(d, c.mode, h)), (a.return = c), (c = a)),
        o(c))
      : n(c, a);
  }
  return F;
...
function sa(e, t) {
  ...
  if (
    ...
    if (((n.flags |= 2048), Qn(9, fa.bind(null, n, r, l, t), void 0, null), Z === null))
      throw Error(y(349));
    xt & 30 || aa(n, t, l);
  }
  return l;
...
function ga(e, t, n) {
  return ((n = n != null ? n.concat([e]) : null), ol(4, 4, ya.bind(null, t, e), n));
}
function So() {}
function wa(e, t) {
  var n = _e();
...
function ka(e, t, n) {
  return xt & 21
    ? (Oe(n, t) || ((n = Ps()), ($.lanes |= n), (Pt |= n), (e.baseState = !0)), t)
  ...
  nd = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qn(9, fa.bind(null, r, u, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function za(e, t, n) {
  ...
  return (
    u !== null &&
      ...
      (n.callback = function () {
        (Cu(e, t), typeof r != 'function' && (ot === null ? (ot = new Set([this])) : ot.add(this)));
        var o = t.stack;
...
function Li(e, t, n, r, l) {
  ...
  if ((Yt(t, l), t.stateNode === null)) (xr(e, t), Pa(t, n, r), Eu(t, n, r, l), (r = !0));
  else if (e === null) {
    var o = t.stateNode,
      i = t.memoizedProps;
    o.props = i;
    ...
    ((o.state = p),
      ...
      i !== r || p !== s || fe.current || Ze
        ? (typeof v == 'function' && (ku(t, n, v, r), (s = t.memoizedState)),
          (i = Ze || Ei(t, n, i, r, p, s, f))
            ? (m ||
    ...
    i !== m || p !== w || fe.current || Ze
      ? (typeof g == 'function' && (ku(t, n, g, r), (w = t.memoizedState)),
        (f = Ze || Ei(t, n, f, r, p, w, s) || !1)
          ? (v ||
...
function Ti(e, t, n, r, l) {
  return (Jt(), oo(l), (t.flags |= 256), le(e, t, n, r), t.child);
}
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            r &&
            ((t.child.flags |= 8192),
            t.mode & 1 && (e === null || U.current & 1 ? Y === 0 && (Y = 3) : No())),
...
function dd(e, t) {
  ...
  for (pu = { focusedElem: e, selectionRange: n }, Dr = !1, k = t; k !== null; )
...
function Ua(e) {
  ...
  (t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null && (delete t[Ie], delete t[An], delete t[hu], delete t[Xc], delete t[Gc])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 13:
      (Pe(t, e),
        ...
        l.flags & 8192 &&
          ...
          !u || (l.alternate !== null && l.alternate.memoizedState !== null) || (_o = W())),
        r & 4 && Di(e));
      break;
    case 22:
      if (
...
function Re(e, t, n, r) {
  ...
  (Xn(e, n, r),
    (!(R & 2) || e !== Z) &&
      (e === Z && (!(R & 2) && (al |= n), Y === 4 && qe(e, q)),
      de(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((tn = W() + 500), ul && pt())));
}
function de(e, t) {
...
function Ha(e, t) {
  ...
  if (t !== 0) {
    if ((t === 2 && ((l = iu(e)), l !== 0 && ((r = l), (t = Iu(e, l)))), t === 1))
      throw ((n = Kn), kt(e, 0), qe(e, r), de(e, W()), n);
    if (t === 6) qe(e, r);
    else {
      if (
        ...
        !(r & 30) &&
          !vd(l) &&
          ((t = Jr(e, r)), t === 2 && ((u = iu(e)), u !== 0 && ((r = u), (t = Iu(e, u)))), t === 1))
      )
        throw ((n = Kn), kt(e, 0), qe(e, r), de(e, W()), n);
...
function qe(e, t) {
  for (
    t &= ~Co, t &= ~al, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
    0 < t;
...
function Ui(e) {
  ...
  if (n === 1) throw ((n = Kn), kt(e, 0), qe(e, t), de(e, W()), n);
    ...
    try {
      ...
      e: {
        ...
        if (
          ...
          var F = xi(o);
          if (F !== null) {
            (!(F.flags & 65536) && (F.flags |= 256), Pi(F, o, i, u, t), oo(en(s, i)));
            break e;
          }
        }
...
function wd(e, t, n) {
  ...
  (r !== null && r.delete(t),
    ...
    Z === e &&
      (q & n) === n &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - _o) ? kt(e, 0) : (Co |= n)),
    de(e, t));
}
function Xa(e, t) {
  ...
  switch (((t.lanes = 0), t.tag)) {
    ...
    case 3:
      e: {
        ...
        ((r = t.pendingProps), (u = t.memoizedState), (l = u.element), ua(e, t), Wr(t, r, null, n));
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 && (Zu(t, n | 1), de(t, W()), !(R & 6) && ((tn = W() + 500), pt()));
      }
      break;
    case 13:
      (Nt(function () {
...
ys = xo;
gs = Nt;
var zd = { usingClientEntryPoint: !1, Events: [Zn, Ft, ll, vs, hs, xo] },
  vn = {
...
function Rd() {
  return Sn.jsxs('div', {
    ...
    children: [
      Sn.jsx('h1', { children: '1.FC Köln Bundesliga Talent Program' }),
      Sn.jsx('p', { children: 'Management System — UI baseline' }),
    ],
  });
}
Wl.createRoot(document.getElementById('root')).render(
  Sn.jsx(wf.StrictMode, { children: Sn.jsx(Rd, {}) }),
);
