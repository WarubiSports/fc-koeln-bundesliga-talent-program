import { Users, Home, Calendar, MessageSquare, ShoppingCart, Settings } from "lucide-react";
...
export default function SectionOverview() {
  ...
  if (isAdmin) {
    sections.push(
      { path: "/house-orders", label: "House Orders", icon: Settings },
      { path: "/admin-events", label: "Admin Events", icon: Calendar }
    );
  }
