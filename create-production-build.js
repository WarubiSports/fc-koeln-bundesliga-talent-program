...
console.log('Creating production build that works without drizzle-orm...');
...
// Step 2: Create production server without drizzle-orm dependencies
...
function getUserFromToken(token) {
  ...
  if (Date.now() > tokenData.expiresAt) {
    // Auto-extend token if within 24 hours of expiry
...
httpServer.listen(port, "0.0.0.0", () => {
  ...
  console.log(\`Production deployment ready - no database dependencies\`);
