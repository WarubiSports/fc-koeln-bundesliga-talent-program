...
<body>
    ...
    <div id="loginPage" class="login-container">
        <div class="login-card">
            ...
            <!-- Login Form -->
            <div id="login-auth-tab" class="auth-tab-content active" style="display: block;">
                <form id="loginForm">
            ...
            <div id="register-auth-tab" class="auth-tab-content" style="display: none;">
    ...
    <script>
        ...
        // Auth tab management (login/register) - ROBUST VERSION
        // CRITICAL AUTHENTICATION FUNCTION - DO NOT MODIFY
        window.showAuthTab = function(tabType) {
            try {
                console.log('Switching to auth tab:', tabType);
                
                // Get tab elements with fallbacks
                const loginTab = document.getElementById('login-auth-tab') || document.getElementById('loginTab');
                const registerTab = document.getElementById('register-auth-tab') || document.getElementById('registerTab');
                const forgotTab = document.getElementById('forgotPasswordTab');
                const tabButtons = document.querySelectorAll('.auth-tab-btn');
                
                // Safety checks
                if (!loginTab || !registerTab) {
                    console.error('Authentication tabs not found:', {loginTab, registerTab});
                    return false;
                }
                ...
                // Activate button if event target exists
                if (window.event && window.event.target) {
                    window.event.target.classList.add('active');
                }
                
                console.log('Auth tab switched successfully to:', tabType);
                return true;
            } catch (error) {
                console.error('Auth tab switch error:', error);
                return false;
            }
        }
        ...
        // Logout
        // ROBUST LOGOUT FUNCTION - Isolated and error-resistant
        window.logout = function() {
            try {
                ...
                const messageField = document.getElementById('loginMessage');
                
                if (emailField) emailField.value = 'max.bisinger@warubi-sports.com';
                if (passwordField) passwordField.value = 'ITP2024';
                if (messageField) messageField.innerHTML = '';
        ...
        // CRITICAL FORGOT PASSWORD FUNCTION - DO NOT MODIFY
        window.showForgotPassword = function() {
            try {
                ...
                if (!forgotTab) {
                    console.error('Forgot password tab not found');
                    return false;
                }
                ...
                console.log('Forgot password form displayed successfully');
                return true;
            } catch (error) {
