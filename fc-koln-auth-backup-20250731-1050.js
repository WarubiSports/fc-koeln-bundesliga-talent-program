    ...
    <script>
        ...
        window.showAuthTab = function(tabType) {
            try {
                ...
                console.error('Auth tab error:', error);
            }
        }
        ...
        // ROBUST FORGOT PASSWORD FUNCTION - Error-resistant
        window.showForgotPassword = function() {
            try {
                const loginTab = document.getElementById('loginTab') || document.getElementById('login-auth-tab');
                ...
                console.log('Forgot password form displayed');
            } catch (error) {
